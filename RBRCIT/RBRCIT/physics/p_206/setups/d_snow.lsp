(("CarSetup"
 Car			("Car"
			MaxSteeringLock			1.4
			FrontRollBarStiffness		20000.0
			RearRollBarStiffness		30000.0	
            )
 Drive			(":-D"
 ...
 WheelLF         (":-D"
		TopMountSlot			4
		vecTopMountPosition		+0.53 -2.420 +0.70
                SteeringRodLength		+0.3362
                StrutPlatformHeight		0.010000
                WheelAxisInclination		-0.093
 ...
 WheelLB         (":-D"
		...
		vecTopMountPosition 		+0.55 +0.00 +0.74
                SteeringRodLength 		+0.4503
                StrutPlatformHeight		0.030000
                WheelAxisInclination		-0.021
                  )

 WheelRB         (":-D"
		TopMountSlot			0
 		vecTopMountPosition 		-0.55 +0.00 +0.74
                SteeringRodLength 		+0.45030
