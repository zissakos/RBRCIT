  ...
  DefManager (		 
			   ...
			   ("CarBody" ("CAR_BODY"
				...
				("HingedBody" ("CAR_DOOR_L"
							...
							vecHingePoint_RF 	 0.788 -2.014  0.396
				...
				("HingedBody" ("CAR_BONNET"
							...
							vecZeroAxis_RF 		 0.0  1.0  0.0
							vecHingePoint_RF 	 0.657 -2.027  0.694
				...
				("HingedBody" ("CAR_EXHAUSTPIPE"
							...
							vecHingeAxis_RF 	 1.0  0.0  0.0	
							vecZeroAxis_RF 		 0.0  1.0  0.0
							vecHingePoint_RF 	 -0.447  0.292  0.095
				...
				("MountedBody" ("CAR_BUMPER_F"
							...
							vecBasePoint_PRF	0.0 -3.014 0.222
							InverseMass		 0.2
							vecLocalInverseInertiaDiagonal	1.0 1.0 1.0
				...
				("MountedBody" ("CAR_BUMPER_B"
							...
							vecBasePoint_PRF	0.0 0.584 0.231
							InverseMass		 0.2
							vecLocalInverseInertiaDiagonal	1.0 1.0 1.0
				...
				("MountedBody" ("CAR_WING"
							...
							vecBasePoint_PRF	0.0 0.669 0.901
							InverseMass		 0.2
							vecLocalInverseInertiaDiagonal	1.0 1.0 1.0
			   ...
			   ("Car" ("CAR_ROOT"
					...
					CarId 1
					  ...
					  vecLocalInverseInertiaDiagonal 0.00078 0.00169 0.00080
