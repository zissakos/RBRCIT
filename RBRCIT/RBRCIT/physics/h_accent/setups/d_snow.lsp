(("CarSetup"
 Car			("Car"
			MaxSteeringLock			1.4
			FrontRollBarStiffness		23000.0
			RearRollBarStiffness		27000.0	
            )
 Drive			(":-D"
 ...
 WheelLF         (":-D"
		TopMountSlot			4
		vecTopMountPosition		+0.53 -2.390 +0.70
                SteeringRodLength		+0.3311
                StrutPlatformHeight		0.010000
                WheelAxisInclination		-0.095
 ...
 WheelLB         (":-D"
		TopMountSlot			0
		vecTopMountPosition 		+0.55 +0.00 +0.74
                SteeringRodLength 		+0.4504
                StrutPlatformHeight		0.035000
                WheelAxisInclination		-0.023
                  )
